...
interface StepperHeaderProps {
    ...
    labelMode: 'numbers' | 'icon-text' | 'icon-only';
}
    ...
    const getStepStatusColor = (stepKey: string, index: number) => {
        ...
        if (isActive) {
            switch (status) {
                ...
                default:
                    return 'border-primary text-primary bg-purple-50';
            }
        }
                                ...
                                <React.Fragment key={step.key}>
                                    ...
                                    {index < steps.length - 1 && (
                                        <div className="flex items-center justify-center">
                                            <motion.div
                                                className={cn(
                                                    'h-1.5 w-full max-w-lg min-w-8 rounded-full transition-colors duration-500',
                                                )}
                                                animate={{
