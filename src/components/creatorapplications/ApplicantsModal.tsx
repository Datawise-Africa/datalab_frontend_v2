...
//             {isPendingStatus(applicant.status) && (
//               <>
//                 <button
//                   onClick={() => handleReject(applicant.id)}
//                   className="px-6 py-2 border border-red-300 text-red-600 rounded-md hover:bg-red-50 transition-colors font-medium"
//                 >
//                   Reject
//                 </button>
//                 <button
...
//               </>
//             )}
//             {isApprovedStatus(applicant.status) && (
//               <button
//                 onClick={() => handleReject(applicant.id)}
//                 className="px-6 py-2 border border-red-300 text-red-600 rounded-md hover:bg-red-50 transition-colors font-medium"
//               >
...
//               </button>
//             )}
//             {isRejectedStatus(applicant.status) && (
//               <button
//                 onClick={() => handleApprove(applicant.id)}
//                 className="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors font-medium"
//               >
        ...
        <div className="p-6">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span className="text-gray-600">
              {applicant.created_at ? format(new Date(applicant.created_at), 'do MMMM yyyy') : 'Unknown'} </span>
              </div>
            {applicant.reviewed && (
              <div className="flex justify-between items-center py-2">
          ...
          {/* Reason for Joining */}
          <div className="mb-8">
            <h4 className="font-medium text-gray-900 mb-4">Reason for Joining</h4>
            <div className="bg-gray-50 p-4 rounded-lg">
          ...
          {/* Attachments */}
          <div className="mb-8">
            <h4 className="font-medium text-gray-900 mb-4">Past Work Attachments</h4>
            <div className="space-y-2">
              {applicant.attachments && applicant.attachments.length > 0 ? (
                applicant.attachments.map((attachment: any, index: number) => (
