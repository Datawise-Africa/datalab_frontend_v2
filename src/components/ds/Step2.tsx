...
export default function Step2({ form }: Step2Props) {
    const dFiles = useFileUpload({
        ...
        onFilesUploaded: (files) => {
            form.setValue('data_files', files);
        },
    });
    const mDataFiles = useFileUpload({
        ...
        maximumFileSize:
            ...
            10 * 1024 * 1024,
        onFilesUploaded: (files) => {
            form.setValue('metadata_files', files);
        },
    });
    const sheetFiles = useFileUpload({
        ...
        maximumFileSize:
            ...
            20 * 1024 * 1024,
        onFilesUploaded: (files) => {
            form.setValue('datasheet_files', files);
        },
    });
                        ...
                        <FormItem>
                            ...
                            >
                                <div className="flex flex-col items-center justify-center gap-2 text-center">
                                    ...
                                    <div>
                                        {mDataFiles.acceptedFileTypes.map(
                                            (type) => (
                                                <Badge
                                                    key={type}
                                                    variant="outline"
                        ...
                        <FormItem>
                            ...
                            >
                                <div className="flex flex-col items-center justify-center gap-2 text-center">
                                    ...
                                    <div>
                                        {sheetFiles.acceptedFileTypes.map(
                                            (type) => (
                                                <Badge
                                                    key={type}
                                                    variant="outline"
