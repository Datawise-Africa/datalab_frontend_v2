...
export function DraftMobileMenu({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Mobile menu overlay */}
      {isOpen && <div className="fixed inset-0 bg-black bg-opacity-50 z-20" onClick={onClose} />}
      ...
      >
        ...
        <div className="p-4">
          <div className="flex items-center space-x-3 rounded-md border border-[#E5E7EB] p-3 mb-4">
