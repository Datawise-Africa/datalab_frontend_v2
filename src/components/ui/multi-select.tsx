...
const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    ...
    const handleSelectAll = () => {
      ...
      const newValue =
        normalizedValue.length === filteredOptions.length ? [] : allValues;
      onChange?.(newValue);
    };
    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent
          className="border-primary/30 w-full bg-white p-0"
          align="start"
        >
          <Command shouldFilter={!onSearch}>
            {showSearch && (
              <div className="border-primary/30 flex items-center border-b-[0.5] px-1">
                <CommandInput
            ...
            <CommandList>
              <CommandEmpty>
                {isSearching || loading ? loadingText : emptyText}
              </CommandEmpty>
              <CommandGroup>
                {showSelectAll &&
                  mode === 'multiple' &&
