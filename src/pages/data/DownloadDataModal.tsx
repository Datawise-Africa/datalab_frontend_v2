...
import type { IDataset, IDatasetProfiteers } from '@/lib/types/data-set';
...
const DownloadDataModal = ({ dataset }: DownloadDataModalProps) => {
  ...
  const profiteerIcons = {
    non_profit: '/assets/datalab/non-profit-icon-dark.svg',
    company: '/assets/datalab/company-icon-dark.svg',
    students: '/assets/datalab/student-icon-dark.svg',
    public: '/assets/datalab/public2-icon-dark.svg',
  } as Record<keyof IDatasetProfiteers, string>;
  ...
  const validateEmail = () => {
    ...
    return (emailTypeValidation as any)[selectedCard];
  };
  ...
  const renderStepContent = () => {
    ...
    const stepContent = (contentMap as any)[step];
