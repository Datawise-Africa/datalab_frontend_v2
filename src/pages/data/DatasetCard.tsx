    ...
    <div className="basis-[25rem] border border-[#ddeeff] p-4 rounded-lg w-86 hover:shadow-2xl transition transform  duration-300 hover:translate-y-[-10px]">
      ...
      <div className="pt-2 flex flex-wrap gap-2">
        {dataset.tags.map((tag, index) => (
          <div
            key={index}
            className="bg-[#ffffff] text-[#101827] font-bold rounded px-3 py-1 text-xs border border-subtle border-2"
          >
            {tag}
          </div>
        ))}
      ...
      <div className="pt-5 flex flex-col space-y-2">
        <div className="flex items-center">
          <img src={'/assets/datalab/spinning-timer.svg'} alt="timer" className="w-4 h-4" />
          <span className="ml-1 text-[#101827] text-xs">
            Created: {dataset.created_at}
          </span>
        </div>
        <div className="flex items-center">
          <img src={'/assets/datalab/db-icon.svg'} alt="database" className="w-4 h-4" />
          <span className="ml-1 text-[#101827] text-xs">
        ...
        <div className="flex items-center">
          <img src={'/assets/datalab/download-icon.svg'} alt="download" className="w-4 h-4 " />
          <span className="ml-1 text-[#101827] text-xs">
      ...
      <div className="mt-4 flex justify-between">
        ...
        >
          <img src={'/assets/datalab/view-icon.svg'} alt="View" className="w-4 h-4" />
        ...
        >
          <img
            src={'/assets/datalab/download-arrow-icon.svg'}
            alt="Download"
