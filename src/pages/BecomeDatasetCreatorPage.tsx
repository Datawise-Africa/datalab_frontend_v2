  ...
  return (
    <div className={cn('mt-12 max-w-7xl mx-auto')}>
      {requestSent ? (
        <div
          className={
            'flex items-center justify-center flex-col text-center gap-4 min-h-[60vh]'
          }
        >
          <div className={cn('mt-5 text-5xl')}>🚀</div>
          <h1 className={'text-2xl font-bold'}>Application Sent</h1>
          <p className={'max-w-[39ch]'}>
            Your application has been received! We’re reviewing your request and
            will notify you via email once approved.
          </p>
          <Button
            onClick={() => navigate('/')}
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <form onSubmit={onSubmit} className={'flex flex-col gap-2'}>
                ...
                <div className="mb-4">
                  ...
                  >
                    <option value="">
                      i.e. Company, University, Research Group
                    </option>
                  ...
                  <div className="border border-gray-300 rounded-md p-8 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        PDF, CSV, XLS, DOC etc. (max. size 20 MB)
                      </p>
                      {fileSelected && (
