...
export const datasetsKeys = {
  ...
  lists: (sessionId: string) => [...datasetsKeys.all, 'list', sessionId] as const,
  detail: (datasetId: string, sessionId: string) =>
    [...datasetsKeys.all, `dataset-${datasetId}`, datasetId, sessionId] as const,
  list: (pagination: PaginationParamsInterface, sort: DatasetSortOptions, sessionId: string) =>
  ...
  filtered: (
    ...
    sessionId: string,
  ) => [...datasetsKeys.all, 'filtered', filters, pagination, sort, sessionId] as const,
};

export const datasetBookmarksKeys = {
  all: ['user-favorite-datasets'] as const,
  lists: (sessionId: string) => [...datasetBookmarksKeys.all, 'list', sessionId] as const,
  ...
  ids: (sessionId: string) => [...datasetBookmarksKeys.all, 'ids', sessionId] as const,
};

export const datasetSearchKeys = {
  all: ['datasetSearch'] as const,
  lists: (sessionId: string) => [...datasetSearchKeys.all, 'list', sessionId] as const,
};
